  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-bold text-gray-900">🚀 AI Bargain Demo</h1>
        <p className="text-gray-600">
          Click "Bargain Now" to see the live chat negotiation with AI emotional
          intelligence
        </p>
      </div>
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                <p className="text-2xl font-bold text-blue-600">
                  ₹{demoFlight.totalPrice.toLocaleString()}
                </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    {demoHotel.name} • {demoHotel.location}
                  </p>
                </div>
              </div>
              <div className="text-right">
                <p className="text-2xl font-bold text-green-600">
                  ₹{demoRoom.totalPrice.toLocaleString()}
                </p>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <ul className="text-sm text-blue-800 space-y-1">
          <li>
            • <strong>Live chat beats</strong> with timed AI responses (≤10s
            total)
          </li>
          <li>
            • <strong>Emotional intelligence</strong> - AI adapts based on your
            offer
          </li>
          <li>
            • <strong>"Negotiated in X.Xs"</strong> badge when complete
          </li>
          <li>
            • <strong>30s countdown timer</strong> for accepted offers
          </li>
          <li>
            • <strong>Bargain Again</strong> option with FOMO messaging
          </li>
          <li>
            • <strong>Module-specific icons</strong> for suppliers (✈️🏨📍🚗)
          </li>
        </ul>
      </div>
