  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-16 md:pb-0">
      ...
      <div className="flex flex-col md:flex-row max-w-7xl mx-auto">
        ...
        <div className="hidden sm:block w-80 flex-shrink-0 desktop-filter">
              ...
              <div className="space-y-1 mt-4">
                ...
                {availableAircraftTypes.map((aircraftType) => (
                  ...
                  >
                    ...
                    <span className="text-sm text-gray-500">{aircraftTypeCounts[aircraftType]}</span>
                  </label>
                ))}
              </div>
      ...
      <Dialog open={false} onOpenChange={() => setBargainCtx(null)}>
