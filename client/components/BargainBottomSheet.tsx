...
interface BargainBottomSheetProps {
  isOpen: boolean;
...
export function BargainBottomSheet({
  isOpen,
  session,
  onClose,
  onAccept,
          ...
          <div className="p-6 border-t bg-white flex-shrink-0">
            ...
            <div className="space-y-3">
              <Button
                ...
                className="w-full bg-green-600 hover:bg-green-700 text-white disabled:opacity-50 h-12 text-base"
              >
                {minDisplayTime ? (
              ...
              {bargainResult.attempt?.canRetry && (
                <Button
                  onClick={handleRetry}
                  variant="outline"
                  className="w-full disabled:opacity-50 h-12 text-base"
                  disabled={isProcessing || minDisplayTime}
                >
                  {minDisplayTime ? (
                    <>Please wait...</>
