...
export const PriceChip: React.FC<PriceChipProps> = ({
  ...
  const baseClasses =
    "inline-flex items-center px-2 py-0.5 rounded-md font-semibold text-base ring-1 ring-inset";
...
export const formatChatTextWithPrices = (
  text: string,
  variant: "emerald" | "slate" | "white" = "emerald",
) => {
  ...
  while ((match = priceRegex.exec(text)) !== null) {
    ...
    parts.push(<PriceChip key={key++} amount={amount} variant={variant} />);
